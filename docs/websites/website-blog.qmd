...
::: callout-note
If you are using RStudio, you can alternatively use the **New Project** command to create a Quarto Blog. Note that this feature is only available in the [preview release](the%20preview%20release%20of%20RStudio,%20you%20can%20also) of RStudio.
:::
...
[![](images/theme-litera.png){style="border: solid silver 1px;"}](https://bootswatch.com/litera/)

**solar**

[![](images/theme-solar.png){style="border: solid silver 1px;"}](https://bootswatch.com/solar/)

**morph**

[![](images/theme-morph.png){style="border: solid silver 1px;"}](https://bootswatch.com/morph/)
:::
:::
...
1.  In the `_quarto.yml` file, add a `site-url` and `description` to the `website` key (without these options being set in the project file, Quarto cannot generated a feed). For example:
...
The article on [Publishing Websites](publishing-websites.qmd) describes in more detail how to publish to the following services:

-   [GitHub Pages](publishing-websites.qmd#github-pages)
-   [Netlify](publishing-websites.qmd#netlify)
-   [RStudio Connect](publishing-websites.qmd#rstudio-connect)
-   [Firebase](publishing-websites.qmd#google-firebase)
-   [Site44](publishing-websites.qmd#site44)
-   [Amazon S3](publishing-websites.qmd#amazon-s3)
